...
$treeRootObj = ontologyToD3Treemap($MODEL_QA_ONTOLOGY,0);
...
$treeRootNodeJSON = json_encode($treeRootObj);
...
?>
	...
	<script type="text/javascript">
		...
		var div = d3.select("#exploration-area").append("div")
		...
		node = div.selectAll("div").data(treemap.nodes(jsonData))
				    .enter().append("div")
				      .attr("class", "treemap-node")
				      .call(position) /*d.children  : null;  ?*/
